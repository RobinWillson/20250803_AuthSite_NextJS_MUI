...
// Use a seeded random function to ensure consistent results
function getRandomColors(seed: number) {
  return colorPermutations[seed % colorPermutations.length];
}
...
function RainbowBackground() {
  ...
  const rainbowDivs = Array.from({ length }, (_, i) => {
    const colors = getRandomColors(i); // Use index as seed for consistency
